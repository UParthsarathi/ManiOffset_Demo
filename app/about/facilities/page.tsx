    ...
    <div className="w-full">
      ...
      <div className="prose prose-slate max-w-none text-[15px] leading-relaxed text-slate-700">
        ...
        <div className="relative aspect-video rounded overflow-hidden shadow-sm border border-slate-200 mb-8">
          <Image src="https://picsum.photos/seed/printingfacility1/1000/600" alt="Mani Offset Production Floor" fill className="object-cover" referrerPolicy="no-referrer" />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-8">
            <div className="relative aspect-video rounded overflow-hidden shadow-sm border border-slate-200">
                <Image src="https://picsum.photos/seed/pressroom2/800/600" alt="Offset Press" fill className="object-cover" referrerPolicy="no-referrer" />
            </div>
            <div className="relative aspect-video rounded overflow-hidden shadow-sm border border-slate-200">
                <Image src="https://picsum.photos/seed/bindery3/800/600" alt="Bindery Segment" fill className="object-cover" referrerPolicy="no-referrer" />
            </div>
        </div>
