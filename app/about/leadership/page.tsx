        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 my-10">
          <div className="flex flex-col gap-4">
            <div className="relative aspect-square w-full sm:w-64 rounded-xl overflow-hidden shadow-sm border border-slate-200">
              <Image src="https://picsum.photos/seed/ceo/400/400" alt="CEO" fill className="object-cover grayscale hover:grayscale-0 transition-all duration-500" referrerPolicy="no-referrer" />
            </div>
            <div>
          ...
          <div className="flex flex-col gap-4">
            <div className="relative aspect-square w-full sm:w-64 rounded-xl overflow-hidden shadow-sm border border-slate-200">
              <Image src="https://picsum.photos/seed/director/400/400" alt="Managing Director" fill className="object-cover grayscale hover:grayscale-0 transition-all duration-500" referrerPolicy="no-referrer" />
            </div>
            <div>
